...
lab = {
    # Due date for labs
    'mon_duedate': date(2023, 12, 6),
    'tues_duedate': date(2023, 11, 29),
    'wed_duedate': date(2023, 11, 29),
    ...
    'parts': [
        {
            'target': targets[0],
            'src': f'{targets[0]}.cc main.cc',
            'header': f'{targets[0]}.h',
            'other_src': '',
            'other_header': '',
            'test_main': 'run_p1',
        },
         {
            'target': targets[1],
            'src': f'{targets[1]}.cc main.cc',
            'header': f'{targets[1]}.h',
            'other_src': '',
            'other_header': '',
            'test_main': 'run_p2',
        },
